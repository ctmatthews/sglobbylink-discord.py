...
- Download and install Python and [discord.py](https://github.com/Rapptz/discord.py)
  - **NOTE: I recommend using the latest version of Python 3.6, e.g. Python 3.6.8. Unfortunately Discord.py is currently incompatible with Python 3.7 and above, and it uses features thatwere added in Python 3.5**
